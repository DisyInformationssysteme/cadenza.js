...
/** @typedef {CadenzaEvent<'selectObjects:info', {layer: WorkbookLayerPath, objectInfo: {formattedValues: Record<string, string>}[]}>} CadenzaSelectObjectsInfoEvent - When the user opened the object info flyout. */
